package com.heaven.lottogenerator
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initAddButton() {
        addButton.setOnClickListener {
            ...
            textView.background = getNumberBackground(numberPicker.value)
    ...
    private fun initRunButton() {
        runButton.setOnClickListener {
            ...
            list.forEachIndexed { index, number ->
                ...
                textView.background = getNumberBackground(number)
    ...
    private fun getNumberBackground(number: Int): Drawable? {
        return when (number) {
